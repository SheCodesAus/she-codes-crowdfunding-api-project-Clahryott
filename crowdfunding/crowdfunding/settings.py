...
AUTH_USER_MODEL = 'users.CustomUser' #we are specifying where to go
...
#this is a dictionary, when your browser remembers you / it remembers you by this SessionAuthentication 